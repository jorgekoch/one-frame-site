...
const Clients = styled.section`
  ...
  text-align: center;
  overflow: hidden;
  h2 { font: clamp(55px, 7vw, 100px) / 0.78 var(--font-display); letter-spacing: -0.07em; margin: 20px 0; text-transform: uppercase; }
  em { font-family: var(--font-accent); font-weight: 400; text-transform: none; color: var(--color-red); }
  .crown { position: absolute; width: 80px; right: 5%; bottom: -12px; }
`;
