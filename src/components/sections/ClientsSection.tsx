...
const Texture = styled.img`position:absolute;z-index:0;top:-12%;left:-8%;width:116%;height:44%;object-fit:cover;opacity:.13;mix-blend-mode:multiply;transform:rotate(-2deg);pointer-events:none;`;
