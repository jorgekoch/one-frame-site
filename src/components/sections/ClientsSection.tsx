...
const Texture = styled.img`position:absolute;z-index:0;top:-12%;left:-15%;width:130%;height:44%;object-fit:fill;opacity:.13;mix-blend-mode:multiply;transform:rotate(-2deg);transform-origin:center;pointer-events:none;`;
