...
const Texture=styled.img`position:absolute;z-index:0;pointer-events:none;filter:grayscale(1) contrast(1.25);&.texture-left{width:62vw;max-width:820px;height:520px;left:-25vw;top:-120px;opacity:.1;mix-blend-mode:screen;transform:rotate(-7deg)}&.texture-right{width:48vw;max-width:620px;height:450px;right:-20vw;bottom:-170px;opacity:.07;mix-blend-mode:screen;transform:rotate(10deg)}`;
