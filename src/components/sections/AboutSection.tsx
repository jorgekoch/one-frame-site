...
export function AboutSection() {
  return (
    <About id="sobre">
      <AboutGraphic>
        <img className="texture texture-a" src={`${A}lines-01.webp`} alt="" aria-hidden="true" loading="lazy" decoding="async" />
        <img className="texture texture-b" src={`${A}lines-04.webp`} alt="" aria-hidden="true" loading="lazy" decoding="async" />
...
const AboutGraphic = styled.div`position:relative;min-height:600px;background:var(--color-red);overflow:hidden;.texture{position:absolute;inset:-12%;width:124%;height:124%;object-fit:cover;pointer-events:none}.texture-a{opacity:.22;mix-blend-mode:multiply;transform:rotate(-4deg) scale(1.08)}.texture-b{opacity:.12;mix-blend-mode:screen;transform:rotate(8deg) scale(1.15)}`;
...
const AboutCopy = styled.div`position:relative;padding:100px 8vw 90px;max-width:800px;overflow:hidden;&::before{content:"";position:absolute;width:520px;height:520px;left:-220px;top:30px;background:url("/assets/lines-02.webp") center/cover no-repeat;opacity:.035;transform:rotate(-12deg);pointer-events:none}&::after{content:"";position:absolute;width:260px;height:260px;right:-115px;bottom:-120px;background:url("/assets/lines-06.webp") center/cover no-repeat;opacity:.06;transform:rotate(18deg);pointer-events:none}h2{position:relative;z-index:1;font:clamp(55px,6vw,90px)/.82 var(--font-display);letter-spacing:-.06em;text-transform:uppercase;margin:22px 0 38px}em{font-family:var(--font-accent);font-weight:400;text-transform:none;letter-spacing:-.08em;color:var(--color-red)}p,a,span{position:relative;z-index:1}p{font-size:16px;line-height:1.25;max-width:560px}`;
