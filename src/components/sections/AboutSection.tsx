...
export function AboutSection() {
  return (
    <About id="sobre">
      <AboutGraphic>
        <img className="tear tear-left" src={`${A}tear-black-left.png`} alt="" aria-hidden="true" loading="lazy" decoding="async" />
        <img className="tear tear-right" src={`${A}tear-black-right.png`} alt="" aria-hidden="true" loading="lazy" decoding="async" />
...
const AboutGraphic = styled.div`position:relative;min-height:600px;background:var(--color-red);overflow:hidden;.tear{position:absolute;pointer-events:none;object-fit:cover;filter:grayscale(1) contrast(1.25)}.tear-left{width:82%;height:115%;left:-30%;top:-8%;opacity:.24;mix-blend-mode:multiply;transform:rotate(-8deg)}.tear-right{width:72%;height:105%;right:-30%;bottom:-10%;opacity:.16;mix-blend-mode:screen;transform:rotate(10deg)}.logo-detail{position:absolute;z-index:1;width:420px;right:-150px;top:50%;transform:translateY(-50%) rotate(12deg);opacity:.09;filter:invert(1);pointer-events:none}`;
...
const AboutCopy = styled.div`position:relative;padding:100px 8vw 90px;max-width:800px;overflow:hidden;&::before{content:"";position:absolute;width:520px;height:520px;left:-220px;top:30px;background:url("/assets/tear-white-left.png") center/cover no-repeat;opacity:.055;transform:rotate(-8deg);pointer-events:none}&::after{content:"";position:absolute;width:260px;height:260px;right:-115px;bottom:-120px;background:url("/assets/logo-symbol-black.png") center/contain no-repeat;opacity:.035;transform:rotate(18deg);pointer-events:none}h2{position:relative;z-index:1;font:clamp(55px,6vw,90px)/.82 var(--font-display);letter-spacing:-.06em;text-transform:uppercase;margin:22px 0 38px}em{font-family:var(--font-accent);font-weight:400;text-transform:none;letter-spacing:-.08em;color:var(--color-red)}p,a,span{position:relative;z-index:1}p{font-size:16px;line-height:1.25;max-width:560px}`;
