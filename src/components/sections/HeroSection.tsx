...
const Hero=styled.section`min-height:830px;position:relative;display:flex;align-items:center;gap:3vw;padding:150px 5vw 80px;background:var(--color-paper);overflow:hidden;@media(max-width:900px){min-height:auto;flex-direction:column;align-items:stretch;gap:0;padding:96px 5vw 56px}`;
const PaperTexture=styled.div`position:absolute;inset:0;opacity:.12;background-image:radial-gradient(var(--color-black) .7px,transparent .7px);background-size:6px 6px;pointer-events:none;`;
...
const MiniLogo=styled.div`font:22px/.72 var(--font-display);margin-bottom:24px;transform:rotate(-2deg);b{font-size:17px;color:var(--color-red)}@media(max-width:900px){margin-bottom:16px}`;
const HeroTitle=styled.h1`font:clamp(82px,10vw,155px)/.78 var(--font-display);letter-spacing:-.07em;margin:0;text-transform:uppercase;text-shadow:4px 4px 0 rgba(239,27,20,.18);em{font-style:normal;color:var(--color-red)}@media(max-width:900px){font-size:clamp(72px,18vw,112px);line-height:.78}`;
const HeroText=styled.p`font-size:14px;line-height:1.2;margin:30px 0 18px;font-weight:700;max-width:390px;@media(max-width:900px){margin:24px 0 18px;max-width:100%}`;
const CTA=styled.a`display:inline-flex;align-items:center;gap:24px;background:var(--color-red);color:var(--color-white);border:2px solid var(--color-black);border-radius:999px;padding:13px 22px;font-size:10px;font-weight:900;letter-spacing:.08em;box-shadow:4px 5px 0 var(--color-black);transition:transform .2s ease,box-shadow .2s ease;&:hover{transform:translate(-2px,-2px);box-shadow:7px 8px 0 var(--color-black)}&:focus-visible{outline:3px solid var(--color-black);outline-offset:5px}span{font-size:16px}`;
const HeroCard=styled.div`position:relative;z-index:2;width:min(48vw,650px);height:min(34vw,430px);background:var(--color-white);border:4px solid var(--color-black);border-radius:28px;padding:12px;box-shadow:12px 14px 0 rgba(239,27,20,.28);transform:rotate(-1.5deg);@media(max-width:900px){width:92%;height:280px;margin:28px auto 0}@media(max-width:600px){width:94%;height:270px;margin-top:24px;border-width:3px;border-radius:24px;padding:10px}`;
const ScrollCue=styled.a`position:absolute;z-index:4;right:5vw;bottom:28px;display:inline-flex;align-items:center;gap:10px;color:var(--color-black);font-size:9px;font-weight:900;letter-spacing:.16em;img{width:28px;height:28px;object-fit:contain;transition:transform .2s ease}&:hover img,&:focus-visible img{transform:translateY(4px)}&:focus-visible{outline:3px solid var(--color-black);outline-offset:5px}@media(max-width:900px){display:none}`;
